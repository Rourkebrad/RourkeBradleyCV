...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top" style="height: 70px !important">
    ...
    <div class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto">
            <li class="{{ Request::path() == '/' ? ' nav-item active' : '' }}" style="color: hotpink;">
                <a class="nav-link" href="/"><b>Home</b></a>
            </li>
            <li class="{{ Request::path() == 'cats' ? ' nav-item active' : '' }}" style="color: hotpink;">
                <a class="nav-link" href="/cats"><b>Cats</b></a>
            </li>
            <li class="{{ Request::path() == 'dogs' ? ' nav-item active' : '' }}" style="color: hotpink;">
